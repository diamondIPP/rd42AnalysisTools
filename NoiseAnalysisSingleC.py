...
class NoiseAnalysisSingleC:
    def __init__(self, run=22011, sourceDir='./', outputDir='', connect=1, chL=0, chH=0):
...
if __name__ == '__main__':
    ...
    z = NoiseAnalysisSingleC(run, source, output, connect, low, high)
